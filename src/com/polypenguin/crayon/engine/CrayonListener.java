        ...
        if (inventory.getName().contains("Menu")) {
            if (inventory.getName().contains("Main")) {
                if (slot == 10) {
                    ...
                    CrayonInterface.openInventory(player, InterfaceUtils.getClipboardView(player));
                } else if (slot == 16) {
                    player.getPlayer().closeInventory();
                }
            ...
            if (inventory.getName().contains("Cuboid")) {
                if (slot == 10) {
                    ...
                    CrayonInterface.openInventory(player, InterfaceUtils.getPyramidDimensionMenu(1));
                } else if (slot == 13) {
